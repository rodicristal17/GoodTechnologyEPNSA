...
define("DB_USER", 'root');
define("DB_PASSWORD", '');
define("DB_NAME", 'syscvxco_admin_academ_uv');
define("DB_HOST", 'localhost');
define("BACKUP_DIR", '../copia_bd'); // Comment this line to use same script's directory ('.')
define("TABLES", '*'); // Full backup
//define("TABLES", 'table1, table2, table3'); // Partial backup
define('IGNORE_TABLES','usuario'); // Tables to ignore
define("CHARSET", 'utf8');
