...
// if($funt=="nuevo"){
	...
	// buscarnivel($user,"ACCESOS"," anhadir='SI' ");
// }
// if($funt=="editar" || $funt=="eliminar"){
	
	// buscarnivel($user,"ACCESOS"," modificar='SI' ");
// }
// if($funt=="buscar"){

	// buscarnivel($user,"ACCESOS"," buscar='SI' ");
// }
...
function abm($acciones,$idabm,$funt)
{
...
function buscar($buscar)
{
	$mysqli=conectar_al_servidor();
	 ...
	 $pagina3='';
		...
		where usuarios_idusario = ? order by lta.nro asc,lta.orden asc";
