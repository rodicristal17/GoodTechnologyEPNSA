...
buscardetalles($idAbmListaNiveles);
...
exit;
	...
	if($funt=="nuevo")
	{
				$consulta= "Select count(*) from listado_niveles where nombre=?  ";
...
if($valor>0)
{
    ...
    $consulta="insert into listado_niveles (nombre, estado,tipo) values (upper(?),?,'Academico')";	
     $stmt = $mysqli->prepare($consulta);
    $ss='ss';
...
function buscarultimaid()
{
	$mysqli=conectar_al_servidor();
	 $cod_niveles='';
		...
		$sql= "Select cod_niveles from listado_niveles where tipo='Academico' order by cod_niveles desc limit 1 ";
...
function buscaracceso($cod_nivelesfk)
{
	$mysqli=conectar_al_servidor();
	 $pagina='';
        ...
        from listadodeacceso where tipo='Academico' order by idlistadodeacceso asc";
...
function buscar($buscar,$estado)
{
	$mysqli=conectar_al_servidor();
	 $pagina='';
        ...
        from listado_niveles where nombre like ? and estado=? and tipo='Academico'  order by nombre asc";
...
function buscardetalles($idAbmListaNiveles)
{
	$mysqli=conectar_al_servidor();
	 $pagina='';
		...
		where cod_nivelesfk='".$idAbmListaNiveles."' order by lta.nro asc";
...
function buscarSelect()
{
	$mysqli=conectar_al_servidor();
		...
		$sql= "Select cod_niveles,nombre,estado
        from listado_niveles where  estado='Activo'  order by nombre asc";
		 $pagina="";
   $stmt = $mysqli->prepare($sql);
