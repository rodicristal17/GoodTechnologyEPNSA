...
function obtener_datos_user(){
	...
	var usuario=buscar_datos_url_usuario('q');
		 var pass=buscar_datos_url_usuario('p');
		
		navegador=obtener_navegor_en_uso();
	   if (usuario!="" || usuario!=undefined || usuario!="undefined"){
	 userid=usuario;
	 passuser=pass;
	...
	if(userid==""){
     ...
     //   window.location="https://rnccomercial.com/appRepartidor/app/login.html";
	}
	if(passuser==""){
			 document.cookie="user=;max-age=86400;path=/";
               document.cookie="pass=;max-age=86400;path=/";
